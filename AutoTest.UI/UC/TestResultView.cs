    ...
    public partial class TestResultView : UserControl
    {
        ...
        private void BindingNavigatorDeleteItem_Click(object sender, EventArgs e)
        {
                ...
                == DialogResult.Yes)
            {
                ...
                {
                    AutoTest.Data.DataStoreSwitcher.Current.Delete<TestCaseInvokeLog>(nameof(TestCaseInvokeLog), (int)log.Cells["编号"].Value);
                }
                BindData();
            }
        }
        ...
        private void ContextMenuStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            else if (e.ClickedItem.Text == "查看请求")
            {
                ...
                if (row != null)
                {
                    ...
                    var log = AutoTest.Data.DataStoreSwitcher.Current.Find<TestCaseInvokeLog>(nameof(TestCaseInvokeLog), id);
        ...
        public void BindData()
        {
            ...
            loadbox.Waiting(this, () =>
            {
                try
                {
                    ...
                    {
                        logs = AutoTest.Data.DataStoreSwitcher.Current.Scan<TestResult>(nameof(TestResult), TestResult.Index_TestCaseId_EnvId_TestDate,
                    ...
                    {
                        var list = AutoTest.Data.DataStoreSwitcher.Current.Scan<TestResult>(nameof(TestResult), TestResult.Index_TestCaseId_EnvId_TestDate,
