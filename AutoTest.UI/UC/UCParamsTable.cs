...
namespace AutoTest.UI.UC
{
    public partial class UCParamsTable : UserControl
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            PbAddParams.Image = Resources.Resource1.control_add;
            PbAddParams.Height = Resources.Resource1.control_add.Height;
            PbAddParams.Width = Resources.Resource1.control_add.Width;
            PbAddParams.Click += PbAddParams_Click;
            PbAddParams.Cursor = Cursors.Hand;

            PbRemParams.Image = Resources.Resource1.control_remove;
            PbRemParams.Height = Resources.Resource1.control_remove.Height;
            PbRemParams.Width = Resources.Resource1.control_remove.Width;
